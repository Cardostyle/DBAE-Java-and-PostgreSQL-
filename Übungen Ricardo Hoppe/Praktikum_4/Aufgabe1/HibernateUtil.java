...
public class HibernateUtil {
    ...
    private static Configuration getConfiguration() {
        ...
        cfg.addAnnotatedClass(Gerät.class);
        cfg.addAnnotatedClass(Desktop.class);
        cfg.addAnnotatedClass(Drucker.class);
        cfg.addAnnotatedClass(Notebook.class);
        cfg.addAnnotatedClass(Rechner.class);
        ...
        cfg.setProperty("hibernate.hbm2ddl.auto", "create"); // e.g. none | validate | update | create | create-drop
    ...
    private static void setDBProperties(){
        try (InputStream input = new FileInputStream("./src/main/resources/config.properties")) {
            ...
            dburl = "jdbc:postgresql://pgsql.ins.hs-anhalt.de:5432/stud05_db";
